...
public class AdviceBeer3Activity_ViewBinding implements Unbinder {
  private AdviceBeer3Activity target;

  @UiThread
  public AdviceBeer3Activity_ViewBinding(AdviceBeer3Activity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AdviceBeer3Activity_ViewBinding(AdviceBeer3Activity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AdviceBeer3Activity target = this.target;
