...
public class AdviceBeer1Activity_ViewBinding implements Unbinder {
  private AdviceBeer1Activity target;

  @UiThread
  public AdviceBeer1Activity_ViewBinding(AdviceBeer1Activity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AdviceBeer1Activity_ViewBinding(AdviceBeer1Activity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AdviceBeer1Activity target = this.target;
